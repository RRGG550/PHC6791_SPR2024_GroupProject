...
ggplot(data = data, aes(x = Year)) + 
  geom_line(aes(y = Overall.Homeless...Female), color = "pink") + 
  geom_line(aes(y = Overall.Homeless...Male), color = "blue") + 
  labs(y = "Overall Homeless")

#Overall Homeless by Race
ggplot(data = data, aes(x = Year)) + 
  geom_line(aes(y = Overall.Homeless...White), color = "grey") + 
  geom_line(aes(y = Overall.Homeless...Black..African.American..or.African)) +
  geom_line(aes(y = Overall.Homeless...Asian.or.Asian.American), color = "blue") + 
  geom_line(aes(y = Overall.Homeless...American.Indian..Alaska.Native..or.Indigenous), color = "red") +
  labs(y = "Overall Homeless")
```
